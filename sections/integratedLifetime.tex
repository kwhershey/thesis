...
\begin{figure}[ht]
\centering
\includegraphics[scale=.25]{integratedLifetime/schematic}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=.25]{integratedLifetime/quenching_correction}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=.25]{integratedLifetime/transient_lifetimes}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=.25]{integratedLifetime/hardware}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=.25]{integratedLifetime/source_measure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=.25]{integratedLifetime/software_controller}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=.25]{integratedLifetime/lifetime_db_import}
