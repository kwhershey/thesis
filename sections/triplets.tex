...
\begin{wrapfigure}{r}{.5\textwidth}
    ...
    \includegraphics[width=0.8\textwidth]{triplets/fluorescence}
    %\subcaption{}
    %\label{fig:5a}\par\vfill

    \includegraphics[width=0.8\textwidth]{triplets/phosphorescence}
    %\subcaption{}
    %\label{fig:5b}
\end{minipage}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.9\textwidth]{triplets/setup}
